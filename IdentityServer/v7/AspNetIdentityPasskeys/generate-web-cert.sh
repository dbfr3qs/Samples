...
# Generate self-signed certificate for web.dev.internal
# This certificate will be used by the WebView app and trusted by the iPhone

CERT_DIR="./WebViewApp/certs"
CERT_NAME="web-dev-cert"
...
echo ""
echo "Files created:"
echo "  - $CERT_DIR/$CERT_NAME.pfx (for .NET WebView app)"
...
echo "3. Run the WebView app with: cd WebViewApp && dotnet run"
echo ""
